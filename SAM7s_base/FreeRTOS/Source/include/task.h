...
portBASE_TYPE getTopUsedPriority();

xList * getReadyTasksList();

xList * getDelayedTasksList();

xList * getOverflowDelayedTasksList();

#if ( INCLUDE_vTaskDelete == 1 )
xList * getTasksWaitingTermination();
#endif

#if ( INCLUDE_vTaskSuspend == 1 )
xList * getSuspendedTasksList();
#endif
