...
portBASE_TYPE vUSBReceiveByte(portCHAR *data){
	...
	return xQueueReceive(xRxCDC, data, portMAX_DELAY);
}
...
{
//*************************************************	
//we do nothing here since we're not using the usb pull-up
...
//*************************************************
//  we are not using the usb pull-up resisitor
//  USB is initialized immediately
