...
#define YAW_RAW_TO_DEGREES_PER_SEC(RAW, ZERO_VALUE) ((float)(RAW - ZERO_VALUE)/ (float)YAW_COUNTS_PER_DEGREE_PER_SEC)
#define ACCEL_RAW_TO_DEGREES_PER_SEC(RAW, ZERO_VALUE) ((float)(RAW - ZERO_VALUE) / (float)ACCEL_COUNTS_PER_G)
