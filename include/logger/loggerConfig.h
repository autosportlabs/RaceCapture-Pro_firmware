...
#define DEFAULT_ADC0_CONFIG {{CHANNEL_Analog1, SAMPLE_1000Hz}, SCALING_5V, 	0, 1.0f, DEFAULT_SCALING_MODE, DEFAULT_SCALING_MAP}
#define DEFAULT_ADC1_CONFIG {{CHANNEL_Analog2, SAMPLE_1000Hz}, SCALING_5V, 	0, 1.0f, DEFAULT_SCALING_MODE, DEFAULT_SCALING_MAP}
#define DEFAULT_ADC2_CONFIG {{CHANNEL_Analog3, SAMPLE_1000Hz}, SCALING_5V, 	0, 1.0f, DEFAULT_SCALING_MODE, DEFAULT_SCALING_MAP}
#define DEFAULT_ADC3_CONFIG {{CHANNEL_Analog4, SAMPLE_1000Hz}, SCALING_5V, 	0, 1.0f, DEFAULT_SCALING_MODE, DEFAULT_SCALING_MAP}
#define DEFAULT_ADC4_CONFIG {{CHANNEL_Analog5, SAMPLE_1000Hz}, SCALING_5V, 	0, 1.0f, DEFAULT_SCALING_MODE, DEFAULT_SCALING_MAP}
#define DEFAULT_ADC5_CONFIG {{CHANNEL_Analog6, SAMPLE_1000Hz}, SCALING_5V, 	0, 1.0f, DEFAULT_SCALING_MODE, DEFAULT_SCALING_MAP}
#define DEFAULT_ADC6_CONFIG {{CHANNEL_Analog7, SAMPLE_1000Hz}, SCALING_5V, 	0, 1.0f, DEFAULT_SCALING_MODE, DEFAULT_SCALING_MAP}
#define BATTERY_ADC7_CONFIG {{CHANNEL_Battery, SAMPLE_1000Hz}, 	 SCALING_12V, 	0, 1.0f, DEFAULT_SCALING_MODE, DEFAULT_SCALING_MAP}
