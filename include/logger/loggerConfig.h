...
#define DEFAULT_GPS_ALTITUDE_CONFIG {"Altitude", "M", 0, 4000, SAMPLE_1Hz, 1, 0}
#define DEFAULT_GPS_SATELLITE_CONFIG {"GPSSats", "", 0, 20, SAMPLE_1Hz, 0, 0}
#define DEFAULT_GPS_QUALITY_CONFIG {"GPSQual", "", 0, 5, SAMPLE_1Hz, 0, 0}
#define DEFAULT_GPS_DOP_CONFIG {"GPSDOP", "", 0, 20, SAMPLE_1Hz, 1, 0}
...
#define DEFAULT_PRED_TIME_CONFIG {"PredTime", "Min", 0, 0, DEFAULT_LAPSTATS_SAMPLE_RATE, 4, 0}
