...
#define DEFAULT_ADC0_CONFIG {{CHANNEL_Analog1, SAMPLE_DISABLED},0.0048875f,1.0f,DEFAULT_SCALING_MODE,DEFAULT_SCALING_MAP}
#define DEFAULT_ADC1_CONFIG {{CHANNEL_Analog2, SAMPLE_DISABLED},0.0048875f,1.0f,DEFAULT_SCALING_MODE,DEFAULT_SCALING_MAP}
#define DEFAULT_ADC2_CONFIG {{CHANNEL_Analog3, SAMPLE_DISABLED},0.0048875f,1.0f,DEFAULT_SCALING_MODE,DEFAULT_SCALING_MAP}
#define DEFAULT_ADC3_CONFIG {{CHANNEL_Analog4, SAMPLE_DISABLED},0.0048875f,1.0f,DEFAULT_SCALING_MODE,DEFAULT_SCALING_MAP}
#define DEFAULT_ADC4_CONFIG {{CHANNEL_Analog5, SAMPLE_DISABLED},0.0048875f,1.0f,DEFAULT_SCALING_MODE,DEFAULT_SCALING_MAP}
#define DEFAULT_ADC5_CONFIG {{CHANNEL_Analog6, SAMPLE_DISABLED},0.0048875f,1.0f,DEFAULT_SCALING_MODE,DEFAULT_SCALING_MAP}
#define DEFAULT_ADC6_CONFIG {{CHANNEL_Analog7, SAMPLE_DISABLED},0.0048875f,1.0f,DEFAULT_SCALING_MODE,DEFAULT_SCALING_MAP}
#define BATTERY_ADC7_CONFIG {{CHANNEL_Battery, SAMPLE_1Hz}, 0.0171f,1.0f,DEFAULT_SCALING_MODE,DEFAULT_SCALING_MAP}
...
#define DEFAULT_PWM_VOLTAGE_SCALING			0.05
