...
//static const Track * g_activeTrack;	//for auto_configure_track
...
// XXX: New auto_configure_track() business conflicting with GPS function.
// Removed for now, along with helper functions. -jrwiebe
