        ...
        for (size_t bitpattern = 0; bitpattern <= 1; bitpattern++) {
                for (size_t endian = 0; endian <= 1; endian++) {
                        for (uint8_t length = 1; length <= 32; length++ ) {
                                ...
                                //for (uint8_t offset = 1; offset < 2; offset++) {
                                        CAN_msg msg;
                                        CANMapping mapping;
