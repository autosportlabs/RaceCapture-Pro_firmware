...
/*-----------------------------------------------------------*/
	...
	char cStatus;
		 ...
		 *
		 * vTaskList() has a dependency on the mod_sprintf() C library function that
		 * might bloat the code size, use a lot of stack, and provide different
		 * results on different platforms.  An alternative, tiny, third party,
		 * and limited functionality implementation of mod_sprintf() is provided in
		...
		*pcWriteBuffer = 0x00;
		...
		if( pxTaskStatusArray != NULL )
		{
			...
			for( x = 0; x < uxArraySize; x++ )
			{
				...
				mod_sprintf( ( char * ) pcWriteBuffer, ( char * ) "%s\t\t%c\t%u\t%u\t%u\r\n", pxTaskStatusArray[ x ].pcTaskName, cStatus, ( unsigned int ) pxTaskStatusArray[ x ].uxCurrentPriority, ( unsigned int ) pxTaskStatusArray[ x ].usStackHighWaterMark, ( unsigned int ) pxTaskStatusArray[ x ].xTaskNumber );
...
/*----------------------------------------------------------*/
	...
	unsigned long ulTotalTime, ulStatsAsPercentage;
		 ...
		 *
		 * vTaskGetRunTimeStats() has a dependency on the mod_sprintf() C library
		 * function that might bloat the code size, use a lot of stack, and
		 * provide different results on different platforms.  An alternative,
		 * tiny, third party, and limited functionality implementation of
		 * mod_sprintf() is provided in many of the FreeRTOS/Demo sub-directories in
			...
			if( ulTotalTime > 0 )
			{
				...
				for( x = 0; x < uxArraySize; x++ )
				{
					...
					else
					{
						...
						#ifdef portLU_PRINTF_SPECIFIER_REQUIRED
						{
							mod_sprintf( ( char * ) pcWriteBuffer, ( char * ) "%s\t\t%lu\t\t<1%%\r\n", pxTaskStatusArray[ x ].pcTaskName, pxTaskStatusArray[ x ].ulRunTimeCounter );
						}
						#else
						{
							/* sizeof( int ) == sizeof( long ) so a smaller
							printf() library can be used. */
							mod_sprintf( ( char * ) pcWriteBuffer, ( char * ) "%s\t\t%u\t\t<1%%\r\n", pxTaskStatusArray[ x ].pcTaskName, ( unsigned int ) pxTaskStatusArray[ x ].ulRunTimeCounter );
						}
						#endif
					}
