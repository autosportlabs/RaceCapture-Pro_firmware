...
#define DEFAULT_ACCEL_X_AXIS_CONFIG  {{DEFAULT_ACCEL_LOGGING_PRECISION,"AccelX", "G", SAMPLE_30Hz}, SAMPLE_5Hz, CONFIG_ACCEL_NORMAL, CONFIG_ACCEL_CHANNEL_X,DEFAULT_ACCEL_ZERO}
#define DEFAULT_ACCEL_Y_AXIS_CONFIG  {{DEFAULT_ACCEL_LOGGING_PRECISION,"AccelY", "G", SAMPLE_30Hz}, SAMPLE_5Hz, CONFIG_ACCEL_NORMAL, CONFIG_ACCEL_CHANNEL_Y,DEFAULT_ACCEL_ZERO}
#define DEFAULT_ACCEL_Z_AXIS_CONFIG  {{DEFAULT_ACCEL_LOGGING_PRECISION,"AccelZ", "G", SAMPLE_30Hz}, SAMPLE_5Hz, CONFIG_ACCEL_NORMAL, CONFIG_ACCEL_CHANNEL_Z,DEFAULT_ACCEL_ZERO}
#define DEFAULT_ACCEL_ZT_AXIS_CONFIG {{DEFAULT_ACCEL_LOGGING_PRECISION,"Yaw", "Deg/Sec", SAMPLE_30Hz}, SAMPLE_5Hz, CONFIG_ACCEL_NORMAL, CONFIG_ACCEL_CHANNEL_ZT,DEFAULT_ACCEL_ZERO}
