...
#define DEFAULT_ADC1_CONFIG {{"Analog2","Units",SAMPLE_100Hz},DEFAULT_ADC_LOGGING_PRECISION,0.0048875f,DEFAULT_SCALING_MODE,DEFAULT_SCALING_MAP}
#define DEFAULT_ADC2_CONFIG {{"Analog3","Units",SAMPLE_50Hz},DEFAULT_ADC_LOGGING_PRECISION,0.0048875f,DEFAULT_SCALING_MODE,DEFAULT_SCALING_MAP}
#define DEFAULT_ADC3_CONFIG {{"Analog4","Units",SAMPLE_40Hz},DEFAULT_ADC_LOGGING_PRECISION,0.0048875f,DEFAULT_SCALING_MODE,DEFAULT_SCALING_MAP}
#define DEFAULT_ADC4_CONFIG {{"Analog5","Units",SAMPLE_20Hz},DEFAULT_ADC_LOGGING_PRECISION,0.0048875f,DEFAULT_SCALING_MODE,DEFAULT_SCALING_MAP}
#define DEFAULT_ADC5_CONFIG {{"Analog6","Units",SAMPLE_10Hz},DEFAULT_ADC_LOGGING_PRECISION,0.0048875f,DEFAULT_SCALING_MODE,DEFAULT_SCALING_MAP}
#define DEFAULT_ADC6_CONFIG {{"Analog7","Units",SAMPLE_5Hz},DEFAULT_ADC_LOGGING_PRECISION,0.0048875f,DEFAULT_SCALING_MODE,DEFAULT_SCALING_MAP}
...
#define DEFAULT_ACCEL_X_AXIS_CONFIG  {{"AccelX", "G", SAMPLE_20Hz}, MODE_ACCEL_NORMAL, ACCEL_CHANNEL_X,DEFAULT_ACCEL_ZERO}
#define DEFAULT_ACCEL_Y_AXIS_CONFIG  {{"AccelY", "G", SAMPLE_20Hz}, MODE_ACCEL_NORMAL, ACCEL_CHANNEL_Y,DEFAULT_ACCEL_ZERO}
#define DEFAULT_ACCEL_Z_AXIS_CONFIG  {{"AccelZ", "G", SAMPLE_20Hz}, MODE_ACCEL_NORMAL, ACCEL_CHANNEL_Z,DEFAULT_ACCEL_ZERO}
#define DEFAULT_ACCEL_ZT_AXIS_CONFIG {{"Yaw", "Deg/Sec", SAMPLE_20Hz}, MODE_ACCEL_NORMAL, ACCEL_CHANNEL_ZT,DEFAULT_YAW_ZERO}
