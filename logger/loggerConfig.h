...
#define MODE_LOGGING_TIMER_PERIOD_USEC		2
#define MODE_LOGGING_TIMER_PERIOD_MS		3
...
#define DEFAULT_RPM_TIMER_CONFIG  {{0,"RPM", "RPM", SAMPLE_DISABLED}, 0, MODE_LOGGING_TIMER_RPM, 1, TIMER_MCK_128, 375428}
#define DEFAULT_FREQUENCY2_CONFIG {{0,"Freq2","Hz", SAMPLE_DISABLED}, 0, MODE_LOGGING_TIMER_FREQUENCY, 1, TIMER_MCK_128, 375428}
#define DEFAULT_FREQUENCY3_CONFIG {{0,"Freq3","Hz", SAMPLE_DISABLED}, 0, MODE_LOGGING_TIMER_FREQUENCY, 1, TIMER_MCK_128, 375428}
...
#define DEFAULT_ACCEL_X_AXIS_CONFIG  {{DEFAULT_ACCEL_LOGGING_PRECISION,"AccelX", "G", SAMPLE_30Hz}, MODE_ACCEL_NORMAL, ACCEL_CHANNEL_X,DEFAULT_ACCEL_ZERO}
#define DEFAULT_ACCEL_Y_AXIS_CONFIG  {{DEFAULT_ACCEL_LOGGING_PRECISION,"AccelY", "G", SAMPLE_30Hz}, MODE_ACCEL_NORMAL, ACCEL_CHANNEL_Y,DEFAULT_ACCEL_ZERO}
#define DEFAULT_ACCEL_Z_AXIS_CONFIG  {{DEFAULT_ACCEL_LOGGING_PRECISION,"AccelZ", "G", SAMPLE_30Hz}, MODE_ACCEL_NORMAL, ACCEL_CHANNEL_Z,DEFAULT_ACCEL_ZERO}
#define DEFAULT_ACCEL_ZT_AXIS_CONFIG {{DEFAULT_ACCEL_LOGGING_PRECISION,"Yaw", "Deg/Sec", SAMPLE_30Hz}, MODE_ACCEL_NORMAL, ACCEL_CHANNEL_ZT,DEFAULT_ACCEL_ZERO}
...
#define DEFAULT_PWM1_CONFIG {{2,"Vout1","V",SAMPLE_DISABLED},MODE_PWM_ANALOG,MODE_LOGGING_PWM_VOLTS,50,100,DEFAULT_PWM_VOLTAGE_SCALING}
#define DEFAULT_PWM2_CONFIG {{2,"Vout2","V",SAMPLE_DISABLED},MODE_PWM_ANALOG,MODE_LOGGING_PWM_PERIOD,50,100,DEFAULT_PWM_VOLTAGE_SCALING}
#define DEFAULT_PWM3_CONFIG {{2,"Vout3","V",SAMPLE_DISABLED},MODE_PWM_ANALOG,MODE_LOGGING_PWM_DUTY,50,100,DEFAULT_PWM_VOLTAGE_SCALING}
#define DEFAULT_PWM4_CONFIG {{2,"Vout4","V",SAMPLE_DISABLED},MODE_PWM_ANALOG,MODE_LOGGING_PWM_PERIOD,50,100,DEFAULT_PWM_VOLTAGE_SCALING}
...
//This is about a 73 foot diameter circle (in the pacific NW...)
#define DEFAULT_GPS_START_FINISH_RADIUS		0.0001

#define DEFAULT_LAP_COUNT_CONFIG {0, "LapCount", "", SAMPLE_DISABLED}
#define DEFAULT_LAP_TIME_CONFIG {0, "LapTime", "", SAMPLE_DISABLED}
...
#define DEFAULT_GPS_TIME_CONFIG {DEFAULT_GPS_TIME_LOGGING_PRECISION, "Time", "Time", SAMPLE_5Hz}
