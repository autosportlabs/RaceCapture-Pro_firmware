...
//This is about a 73 foot diameter circle
...
#define DEFAULT_RPM_TIMER_CONFIG  {{0,"RPM", "RPM", SAMPLE_DISABLED}, 0, CONFIG_LOGGING_TIMER_RPM, 1, MCK_128, 375428}
#define DEFAULT_FREQUENCY2_CONFIG {{0,"Freq2","Hz", SAMPLE_DISABLED}, 0, CONFIG_LOGGING_TIMER_FREQUENCY, 1, MCK_128, 375428}
