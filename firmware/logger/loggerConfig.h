...
#define DEFAULT_GPS_CONFIG {CONFIG_FEATURE_INSTALLED, DEFAULT_GPS_QUAL_CONFIG, DEFAULT_GPS_SATELLITES_CONFIG, DEFAULT_GPS_LATITUDE_CONFIG, DEFAULT_GPS_LONGITUDE_CONFIG, DEFAULT_GPS_TIME_CONFIG, DEFAULT_GPS_VELOCITY_CONFIG}
