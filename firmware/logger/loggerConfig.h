...
#define DEFAULT_FREQUENCY2_CONFIG {"Freq2","Hz", 1, SAMPLE_DISABLED, CONFIG_LOGGING_TIMER_FREQUENCY, 1, MCK_128, 375428}
#define DEFAULT_FREQUENCY3_CONFIG {"Freq3","Hz", 1, SAMPLE_DISABLED, CONFIG_LOGGING_TIMER_FREQUENCY, 1, MCK_128, 375428}
